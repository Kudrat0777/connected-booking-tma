...
export const translations: TranslationsDictionary = {
  en: {
    ...
    // === Master Edit Profile Screen ===
    m_edit_error_img: "Image error",
    m_edit_btn_save: "SAVE",
    m_edit_name_required: "Please provide your name.",
    m_edit_save_error: "Error saving profile",
    m_edit_avatar_error: "Error uploading avatar",
    m_edit_portfolio_error: "Error uploading photo",
    m_edit_delete_photo_confirm: "Delete this photo from portfolio?",
    m_edit_delete_error: "Deletion error",
    m_edit_tap_to_change: "Tap on the photo to change",
    m_edit_ton_footer: "Link your wallet to receive crypto payments in the future.",
    m_edit_personal_data: "Personal Data",
    m_edit_name_header: "Name",
    m_edit_name_placeholder: "What is your name?",
    m_edit_exp_header: "Experience (years)",
    m_edit_exp_placeholder: "e.g. 5",
    m_edit_bio_header: "About me",
    m_edit_bio_placeholder: "Tell about your experience and skills...",
    m_edit_location_header: "Location and contacts",
    m_edit_location_footer: "Provide your phone number and exact address or paste a link to Yandex/Google Maps.",
    m_edit_city_header: "City",
    m_edit_address_header: "Address or map link",
    m_edit_address_placeholder: "e.g. 10 Amir Temur St. or map link...",
    m_edit_portfolio_header: "My portfolio",
    m_edit_portfolio_footer: "Upload photos of your best works (up to 10).",
    m_edit_btn_add: "Add",

    // === Master Schedule Screen ===
    m_schedule_title: "Auto-schedule",
    m_schedule_desc: "Specify your working hours. The system will automatically create empty slots for booking for this period.",
    m_schedule_period: "Generation period",
    m_schedule_start_date: "From date",
    m_schedule_end_date: "To date",
    m_schedule_working_days: "Working days of the week",
    m_schedule_working_hours: "Working hours",
    m_schedule_start_time: "Start of working day",
    m_schedule_end_time: "End of working day",
    m_schedule_interval: "Interval (booking step)",
    m_every_15_min: "Every 15 minutes",
    m_every_30_min: "Every 30 minutes",
    m_every_60_min: "Every 1 hour",
    m_every_90_min: "Every 1.5 hours",
    m_every_120_min: "Every 2 hours",
    m_schedule_no_services_desc: "First, add at least one service to generate booking slots for it.",
    m_schedule_error_days: "Select at least one working day",
    m_schedule_error_dates: "Start date cannot be later than end date",
    m_schedule_error_time: "Working hours specified incorrectly",
    m_schedule_success_1: "Schedule successfully created!\nSlots generated:",
  ...
  ru: {
    ...
    // === Master Edit Profile Screen ===
    m_edit_error_img: "Ошибка",
    m_edit_btn_save: "СОХРАНИТЬ",
    m_edit_name_required: "Пожалуйста, укажите ваше имя.",
    m_edit_save_error: "Ошибка при сохранении профиля",
    m_edit_avatar_error: "Ошибка загрузки аватара",
    m_edit_portfolio_error: "Ошибка загрузки фото",
    m_edit_delete_photo_confirm: "Удалить это фото из портфолио?",
    m_edit_delete_error: "Ошибка удаления",
    m_edit_tap_to_change: "Нажмите на фото, чтобы изменить",
    m_edit_ton_footer: "Привяжите кошелек для получения оплаты в крипте в будущем.",
    m_edit_personal_data: "Личные данные",
    m_edit_name_header: "Имя",
    m_edit_name_placeholder: "Как вас зовут?",
    m_edit_exp_header: "Опыт работы (лет)",
    m_edit_exp_placeholder: "Например: 5",
    m_edit_bio_header: "О себе",
    m_edit_bio_placeholder: "Расскажите о своем опыте и навыках...",
    m_edit_location_header: "Локация и контакты",
    m_edit_location_footer: "Укажите номер телефона и точный адрес или вставьте ссылку на Яндекс/Google Карты.",
    m_edit_city_header: "Город",
    m_edit_address_header: "Адрес или ссылка на карту",
    m_edit_address_placeholder: "Ул. Амира Темура 10, либо ссылка https://yandex.ru/maps/...",
    m_edit_portfolio_header: "Мое портфолио",
    m_edit_portfolio_footer: "Загрузите фото ваших лучших работ (до 10 шт).",
    m_edit_btn_add: "Добавить",

    // === Master Schedule Screen ===
    m_schedule_title: "Авто-расписание",
    m_schedule_desc: "Укажите ваш график работы. Система автоматически создаст пустые окна для записи на этот период.",
    m_schedule_period: "Период генерации",
    m_schedule_start_date: "С какого числа",
    m_schedule_end_date: "По какое число",
    m_schedule_working_days: "Рабочие дни недели",
    m_schedule_working_hours: "Время работы",
    m_schedule_start_time: "Начало рабочего дня",
    m_schedule_end_time: "Конец рабочего дня",
    m_schedule_interval: "Интервал (шаг записи)",
    m_every_15_min: "Каждые 15 минут",
    m_every_30_min: "Каждые 30 минут",
    m_every_60_min: "Каждый 1 час",
    m_every_90_min: "Каждые 1.5 часа",
    m_every_120_min: "Каж��ые 2 часа",
    m_schedule_no_services_desc: "Сначала добавьте хотя бы одну услугу, чтобы сгенерировать для неё слоты записи.",
    m_schedule_error_days: "Выберите хотя бы один рабочий день",
    m_schedule_error_dates: "Дата начала не может быть позже даты окончания",
    m_schedule_error_time: "Неверно указано время работы",
  ...
  uz: {
    ...
    // === Master Edit Profile Screen ===
    m_edit_error_img: "Xatolik",
    m_edit_btn_save: "SAQLASH",
    m_edit_name_required: "Iltimos, ismingizni kiriting.",
    m_edit_save_error: "Profilni saqlashda xatolik",
    m_edit_avatar_error: "Avatarni yuklashda xatolik",
    m_edit_portfolio_error: "Rasmni yuklashda xatolik",
    m_edit_delete_photo_confirm: "Ushbu rasmni portfelidan o'chirasizmi?",
    m_edit_delete_error: "O'chirishda xatolik",
    m_edit_tap_to_change: "O'zgartirish uchun rasmga bosing",
    m_edit_ton_footer: "Kelajakda kriptoda to'lov olish uchun hamyonni ulang.",
    m_edit_personal_data: "Shaxsiy ma'lumotlar",
    m_edit_name_header: "Ism",
    m_edit_name_placeholder: "Ismingiz nima?",
    m_edit_exp_header: "Ish tajribasi (yil)",
    m_edit_exp_placeholder: "Masalan: 5",
    m_edit_bio_header: "Men haqimda",
    m_edit_bio_placeholder: "Tajribangiz va ko'nikmalaringiz haqida gapirib bering...",
    m_edit_location_header: "Joylashuv va aloqa",
    m_edit_location_footer: "Telefon raqamingiz va aniq manzilingizni kiriting yoki Yandex/Google Xaritalar havolasini qo'ying.",
    m_edit_city_header: "Shahar",
    m_edit_address_header: "Manzil yoki xarita havolasi",
    m_edit_address_placeholder: "Amir Temur ko'chasi, 10, yoki havola...",
    m_edit_portfolio_header: "Mening portfelim",
    m_edit_portfolio_footer: "Eng yaxshi ishlaringiz rasmlarini yuklang (10 tagacha).",
    m_edit_btn_add: "Qo'shish",

    // === Master Schedule Screen ===
    m_schedule_title: "Avto-jadval",
    m_schedule_desc: "Ish jadvalingizni kiriting. Tizim ushbu davr uchun yozilish uchun bo'sh joylarni avtomatik ravishda yaratadi.",
    m_schedule_period: "Yaratish davri",
    m_schedule_start_date: "Qaysi sanadan",
    m_schedule_end_date: "Qaysi sanagacha",
    m_schedule_working_days: "Haftaning ish kunlari",
    m_schedule_working_hours: "Ish vaqti",
    m_schedule_start_time: "Ish kunining boshi",
    m_schedule_end_time: "Ish kunining oxiri",
    m_schedule_interval: "Interval (yozilish qadami)",
    m_every_15_min: "Har 15 daqiqada",
    m_every_30_min: "Har 30 daqiqada",
    m_every_60_min: "Har 1 soatda",
    m_every_90_min: "Har 1.5 soatda",
    m_every_120_min: "Har 2 soatda",
    m_schedule_no_services_desc: "Yozilish joylarini yaratish uchun avval kamida bitta xizmat qo'shing.",
    m_schedule_error_days: "Kamida bitta ish kunini tanlang",
    m_schedule_error_dates: "Boshlanish sanasi tugash sanasidan kech bo'lishi mumkin emas",
    m_schedule_error_time: "Ish vaqti noto'g'ri kiritilgan",
    m_schedule_success_1: "Jadval muvaffaqiyatli yaratildi!\nYaratilgan joylar:",
